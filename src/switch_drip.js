    var drip_switch_channel = '2402050';
    var dripswitch_readkey = '9L7ZEHSY9LH0N843';
    var dripswitch_writekey = '1CY2YPSRCY1SV0NQ';
    
    var drip_masterswitch_channel = '2402072';
    var drip_masterswitch_readkey = 'BQNA8FHN0PMB3XAQ';
    var drip_masterswitch_writekey = 'RHQ1UVRPB4I75Z89';
...
fetch('https://api.thingspeak.com/channels/' + drip_switch_channel + '/fields/5.json?results=1')
...
fetch('https://api.thingspeak.com/channels/' + drip_masterswitch_channel + '/fields/6.json?results=1')
  .then(response => response.json())
  .then(data => {
    if (data && data.feeds && data.feeds.length > 0) {
...
function sendToThingSpeak5(value) {
  fetch('https://api.thingspeak.com/update?api_key='+dripswitch_writekey+'&field5=' + value)
...
function sendToThingSpeak6(value) {
  fetch('https://api.thingspeak.com/update?api_key='+drip_masterswitch_writekey+'&field6=' + value)
    .then(response => response.text())
    .then(data => {
      console.log(data);
...
$(document).ready(function () {
    ...
    function fetchSolenoidStatus() {
        ...
        var solenoidStatusURL = 'https://api.thingspeak.com/channels/' + drip_switch_channel + '/feeds/last.json?api_key=' + dripswitch_readkey;
        ...
        $.getJSON(solenoidStatusURL, function (solenoidData) {
            if (solenoidData) {
                ...
                $('#drip_solenoid').html(solenoidValue);
                $('#drip_solenoidstatus').html(solenoidStatus);
                $('#drip_solenoidtimestamp').html( createdAt);
